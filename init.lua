...
-- We use a separate name (vimrc.vim) to avoid Neovim loading both automatically
...
-- vim.lsp.enable is the new modern way to start servers
if vim.lsp.enable then
    vim.lsp.enable('pyright')
    vim.lsp.enable('ts_ls')
    
    -- Example for perlls if needed:
